...
public class DoctorReviewDetailedFragment extends Fragment implements View.OnClickListener {
    ...
    private ImageButton imBtnEditReview;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnDoctorReviewDetailedFragmentDataListener) {
            ...
            throw new RuntimeException(context.toString() + " must implement OnDoctorReviewDetailedFragmentDataListener");
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.imBtnEditReview:
                ...
                Toast.makeText(getContext(), "Окно редактирования отзыва", Toast.LENGTH_SHORT).show();
                break;
            case R.id.chbLike:
                if (chbLike.isChecked()) {
                    sendLike(serviceId, reviewId);
                } else {
                    deleteLike(serviceId, reviewId);
                }
            ...
            case R.id.chbDislike:
                if (chbDislike.isChecked()) {
                    sendDislike(serviceId, reviewId);
                } else {
                    deleteLike(serviceId, reviewId);
                }
